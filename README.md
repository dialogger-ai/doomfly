...
**This branch is for experiments.** Continue visual-state diagnosis, teacher comparisons and reward/synaptic research here. The watched gameplay baseline lives on `main`.
